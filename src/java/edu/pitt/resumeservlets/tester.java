...
public class tester extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Diagnosis diag = new Diagnosis("7c15472e-40a6-11e3-a2df-6cdd11ba7310");
            Symptom symp = new Symptom("651fe600-40a6-11e3-a2df-6cdd11ba7310");
     
            //out.print(symp.getSymptomAsJSON());
            out.print(diag.getDiagnosisAsJSON());
        }
    }
